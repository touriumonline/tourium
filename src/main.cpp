...
#if defined(NDEBUG)
#error "Tourium cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Tourium Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight > 0 && nHeight <= 2000) {
		...
		nSubsidy = 3 * COIN;
	} else if (nHeight > 20000 && nHeight <= 60000) {
		nSubsidy = 4* COIN;
