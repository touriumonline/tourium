...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Tourium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tourium features */
        {"tourium", "masternode", &masternode, true, true, false},
        {"tourium", "masternodelist", &masternodelist, true, true, false},
        {"tourium", "mnbudget", &mnbudget, true, true, false},
        {"tourium", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"tourium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tourium", "mnsync", &mnsync, true, true, false},
        {"tourium", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"tourium", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use touriumd, or the -server option to tourium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> tourium-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15111/\n";
}
