...
#define SPORK_5_MAX_VALUE_DEFAULT 1000                            //1000 TOCN
...
#define SPORK_16_MN_WINNER_MINIMUM_AGE_DEFAULT 0           // Age in seconds. This should be > MASTERNODE_REMOVAL_SECONDS to avoid misconfigured new nodes in the list.
