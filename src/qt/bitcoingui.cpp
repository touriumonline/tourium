                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tourium-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tourium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tourium: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tourium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tourium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tourium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tourium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tourium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Tourium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tourium Core help message to get a list with possible Tourium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tourium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tourium network", "", count));
}
...
{
    QString strTitle = tr("Tourium Core"); // default title
