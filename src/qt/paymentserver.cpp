...
const char* BIP71_MIMETYPE_PAYMENT = "application/tourium-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/tourium-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/tourium-paymentrequest";
