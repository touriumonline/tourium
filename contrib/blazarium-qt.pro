...
RESOURCES += src/qt/tourium.qrc src/qt/tourium_locale.qrc

TRANSLATIONS += src/qt/locale/tourium_bg.ts \
                src/qt/locale/tourium_de.ts \
                src/qt/locale/tourium_en.ts \
                src/qt/locale/tourium_es.ts \
                src/qt/locale/tourium_fi.ts \
                src/qt/locale/tourium_fr.ts \
                src/qt/locale/tourium_it.ts \
                src/qt/locale/tourium_ja.ts \
                src/qt/locale/tourium_pl.ts \
                src/qt/locale/tourium_pt.ts \
                src/qt/locale/tourium_ru.ts \
                src/qt/locale/tourium_sk.ts \
                src/qt/locale/tourium_sv.ts \
                src/qt/locale/tourium_vi.ts \
                src/qt/locale/tourium_zh_CN.ts \
                src/qt/locale/tourium_zh_TW.ts
